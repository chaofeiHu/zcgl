...
<head>
    ...
    <script type="text/javascript">
        var me = {
            ...
            edit_window: null,
            tree1: null,
            actionUrl: '<%=basePath%>/ParamDeclare/'
        };
            ...
            me.tree1.tree({
                ...
                onLoadSuccess: function (node, param) {
                    ...
                    if (selectedNode)
                        ...
                        if ($("#unitCode").val()==null||$("#unitCode").val()==''){
                            chakan(param[0].id);
                        } else {
                            chakan($("#unitCode").val());
                        }
        ...
        function chakan(unitCode) {
                $("#unitCode").val(unitCode);
                $.ajax({
                    url: me.actionUrl + 'select.do?unitCode=' + unitCode,
...
<div region="west" hide="true" split="true" title="组织机构" style="width: 400px;">
    <ul id="tree1">
    </ul>
</div>
