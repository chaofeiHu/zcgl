...
<head>
    ...
    <script type="text/javascript">
        ...
        var me = {
            ...
            actionUrl: '<%=basePath%>/ResultPublicity/'
        };
        ...
        function loadGrid() {
            ...
            var ispublicity = $("#ispublicity").val();
            ...
            me.datagrid1.datagrid({
                ...
                columns: [[
                    ...
                    {field: 'groupId', title: '专业组名称', width: 200, align: 'center',},
                    ...
                    {field: 'groupResult', title: '专业组是否通过', width: 140, align: 'center',
                        formatter: function (value, rowData, rowIndex) {
                    ...
                    {field: 'reviewResultNo', title: '大评会反对票数', width: 140, align: 'center',},
                    {field: 'reviewResultWaive', title: '大评会弃权票数', width: 140, align: 'center',},
                    {field: 'reviewResultOpinion', title: '大评会评议意见', width: 140, align: 'center',},
                    {field: 'reviewResult', title: '大评会是否通过', width: 140, align: 'center',
                        formatter: function (value, rowData, rowIndex) {
                            if(value==1||value=="1") return "通过";
                            if(value==0||value=="0") return "不通过";
                    ...
                    {field: 'ispublicity', title: '是否已公示', width: 100, align: 'center',
                        formatter: function (value, rowData, rowIndex) {
                            if(value==1||value=="1") return "已公示";
                            else return "未公示";
                        }},
                    {field: 'opt', title: '操作', width: 300, align: 'center',
                        formatter: function (value, rowData, rowIndex) {
                            ...
                            strReturn += '<a href="javascript:void(0)"   title="转评审结果管理" onClick="toResultManage(\'' + rowData['id'] +'\');" style="padding-left:20px;" >转评审结果管理</a>'
                            return strReturn;
                        }
                    },
                ...
                toolbar: [
                    {
                        text: '转评审结果管理', iconCls: 'icon-ok', handler: function () {
                    ...
                    {
                        text: '导出当前页面人员信息', iconCls: 'icon-excel', handler: function () {
                        ...
                        var val='?judgingCode='+$("#judgingName").val()+'&yearNo='+$("#yearNo").val()+'&areaCode='+$("#areaCode").val()+
                            $("#ispublicity").val()+'&userName='+$("#userName").textbox().textbox('getValue')+'&reviewSeries='+$("#reviewSeries").val()
                            +'&professialCode='+$("#professialCode").val()+'&ispublicity='+$("#ispublicity").val()+'&page='+page+'&rows='+rows;
        ...
        //转评审结果管理
        function toResultManage(ids) {
            $.messager.confirm('提示信息', '是否确认转评审结果管理？', function (isClickedOk) {
                if (isClickedOk) {
                    $.ajax({
                        url: me.actionUrl + 'toResultManage.do',
                        data: {ids: ids},
...
<div data-options="region:'north'" style="height:73px">
    <table>
        <tr>
            ...
            <td>是否已公示：</td>
            <td>
                <select name="ispublicity" id="ispublicity" class="easyui-combobox" style="width:200px">
