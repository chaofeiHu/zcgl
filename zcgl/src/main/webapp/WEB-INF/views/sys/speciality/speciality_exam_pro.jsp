...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            pageInit();
            loadGrid();
            chongyong('<%=basePath%>/BaseUnit/selectListWhereByUnit', '#pwh', 'ID', 'TEXT');
        ...
        function pageInit() {
            ...
            $('#btn_search_cancel').click(function () {
                ...
                var va = '?judgingStage=${currentJudgingStage}&displayName2=' + $('#displayName2').val()
                    ...
                    + '&dqzt=' + $('#dqzt').combobox('getValue')
                    + '&page=' + page + '&rows=' + rows;
                window.location.href = me.actionUrl + 'exportExcelProposerCan.do' + va;
        ...
        function loadGrid() {
            me.datagrid1.datagrid({
                idField: me.idFiled,
                url: me.actionUrl + 'GetJudgingProposerListCan.do',
                frozenColumns: [[
                    {
    ...
    <div class="easyui-layout" fit="true">
        <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
            <form id="edit_form" name="edit_form" method="post">
                    ...
                    <div style="width: 100%;margin-bottom: 10px">
                        <table style="border: solid 1px #b7aaaa;width: 100%">
                            <tr>
                                ...
                                <td colspan="9">
                                    <span id="finalResult1"><input type="radio" name="finalResult" value="1"
                                                                   checked="checked"/>通过</span>
                ...
                <div id="tijiao" style="width: 400px; margin: 0px auto;margin-top: 20px">
