...
<head>
    ...
    <script type="text/javascript">
        ...
        var me = {
            ...
            actionUrl: '<%=basePath%>/ResultDissent/'
        };
        ...
        function loadGrid() {
            ...
            me.datagrid1.datagrid({
                ...
                toolbar: [
                    {
                        text: '删除选中数据', iconCls: 'icon-remove', handler: function () {
                    ...
                    {
                        text: '导出未通过人员', iconCls: 'icon-excel', handler: function () {
       ...
       //删除数据
        function Delete(ids) {
            $.messager.confirm('提示信息', '是否确认删除数据？', function (isClickedOk) {
                if (isClickedOk) {
                    $.ajax({
